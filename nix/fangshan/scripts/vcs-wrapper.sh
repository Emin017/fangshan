...
_FangShan_SIM_RESULT_DIR=${FangShan_SIM_RESULT_DIR:-"fangshan-sim-result"}
_CURRENT="$_FangShan_SIM_RESULT_DIR"/all/"$_NOW"
mkdir -p "$_CURRENT"
ln -sfn "all/$_NOW" "$_FangShan_SIM_RESULT_DIR/result"
...
echo "VCS emulator finished, result saved in $_FangShan_SIM_RESULT_DIR/result"
